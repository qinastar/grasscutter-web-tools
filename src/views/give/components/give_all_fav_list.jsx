...
function GiveAllFavList() {
  ...
  const tableColumns = [
    ...
    },
    {
      ...
      render: (_, row) => {
        return <Space>
          <span>{row.name}, {row.count}个, {!row.isDrop ? `lv${row.level}` : '掉落'}</span>
